...
double PunValor(int jugador, const Environment &estado){
    double suma=0;
    int    contador=0;
         ...
         if (j==0){
                if (i==0){
                    ...
                    if (estado.See_Casilla(i+1,j+1)==jugador)
                        ...
                        suma--;
                    if (estado.See_Casilla(i+1,j)==jugador&&estado.See_Casilla(i,j+1)==jugador&&estado.See_Casilla(i+1,j+1)==jugador)
                        suma+10;
                    ...
                    if (estado.See_Casilla(i+1,j+1)==jugador)
                     ...
                     if (estado.See_Casilla(i-1,j+1)==jugador)
                        ...
                        suma--;
                     if (estado.See_Casilla(i+1,j)==jugador&&estado.See_Casilla(i,j+1)==jugador&&estado.See_Casilla(i+1,j+1)==jugador&&estado.See_Casilla(i-1,j)==jugador&&estado.See_Casilla(i-1,j+1)==jugador)
                        suma+10;
                ...
                if (i==0){
                    ...
                    if (estado.See_Casilla(i+1,j-1)==jugador)
                        ...
                        suma--;
                    if (estado.See_Casilla(i,j+1)==jugador&&estado.See_Casilla(i,j-1)==jugador&&estado.See_Casilla(i+1,j)==jugador&&estado.See_Casilla(i+1,j+1)==jugador&&estado.See_Casilla(i+1,j-1)==jugador)
                        suma+10;
                    ...
                    if (estado.See_Casilla(i+1,j+1)==jugador)
                     ...
                     if (estado.See_Casilla(i-1,j-1)==jugador)
                        ...
                        suma--;
                     if (estado.See_Casilla(i+1,j)==jugador&&estado.See_Casilla(i,j+1)==jugador&&estado.See_Casilla(i-1,j)==jugador&&estado.See_Casilla(i,j-1)==jugador&&estado.See_Casilla(i+1,j+1)==jugador&&estado.See_Casilla(i+1,j-1)==jugador&&estado.See_Casilla(i-1,j+1)==jugador&&estado.See_Casilla(i-1,j-1)==jugador)
                        suma+10;
               ...
               if (i==0){
                    ...
                    if (estado.See_Casilla(i+1,j)==jugador&&estado.See_Casilla(i,j-1)==jugador&&estado.See_Casilla(i+1,j-1)==jugador)
                     ...
                     if (estado.See_Casilla(i-1,j-1)==jugador)
                        ...
                        suma--;
                     if (estado.See_Casilla(i,j-1)==jugador&&estado.See_Casilla(i-1,j)==jugador&&estado.See_Casilla(i-1,j-1)==jugador)
                        suma+10;
                    ...
                    if (estado.See_Casilla(i,j-1)==jugador)
                     ...
                     if (estado.See_Casilla(i+1,j-1)==jugador)
                        ...
                        suma--;
                     if (estado.See_Casilla(i+1,j)==jugador&&estado.See_Casilla(i-1,j)==jugador&&estado.See_Casilla(i,j-1)==jugador&&estado.See_Casilla(i-1,j-1)==jugador&&estado.See_Casilla(i+1,j-1)==jugador)
                        suma+10;
...
int BuscaTres(int jugador,const Environment&estado){
   int suma=0;
     for (int i=0; i<7; i++){
      for (int j=0; j<7; j++){
...
int BuscaDos(int jugador,const Environment&estado){
   int suma=0;
...
int BuscaUno(int jugador,const Environment&estado){
   int suma=0;
...
double PunValor2(int jugador,const Environment&estado){
  ...
  suma=BuscaTres(jugador,estado);
  suma=suma+BuscaDos(jugador,estado);
  suma=suma+BuscaUno(jugador,estado);
 //cout << suma;
  return suma;
}
